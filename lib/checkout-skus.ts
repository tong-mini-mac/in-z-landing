...
export const CHECKOUT_SKUS: CheckoutSku[] = [
  {
    ...
    detail: { en: "1,000 rows / month (dialogue or document)", th: "1,000 แถว / เดือน (บทสนทนาหรือเอกสาร)" },
    amountBaht: 2900,
    interval: "month",
    model: "saas",
  },
  {
    ...
    detail: { en: "5,000 rows / month (dialogue or document)", th: "5,000 แถว / เดือน (บทสนทนาหรือเอกสาร)" },
    amountBaht: 12900,
    interval: "month",
    model: "saas",
  },
  {
    ...
    detail: { en: "20,000 rows / month (dialogue or document)", th: "20,000 แถว / เดือน (บทสนทนาหรือเอกสาร)" },
    amountBaht: 39000,
    interval: "month",
    model: "saas",
  },
  ...
  },
  {
    ...
    productName: "NetR",
    planId: "prepaid_15m",
    label: { en: "Prepaid 24 hours", th: "Prepaid 24 ชม." },
    detail: {
      en: "1,440 chat minutes · deducted per minute",
      th: "1,440 นาที · หักเป็นนาที",
    },
    amountBaht: 30,
    interval: "one_time",
    model: "saas",
  ...
  },
  {
    ...
    detail: { en: "3 hours / day", th: "3 ชม. / วัน" },
    amountBaht: 99,
    interval: "month",
    model: "saas",
    minutes: 180,
